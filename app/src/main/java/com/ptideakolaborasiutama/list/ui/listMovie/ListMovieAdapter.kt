...
import com.ptideakolaborasiutama.list.databinding.ItemListMovieBinding
...
class ListMovieAdapter: RecyclerView.Adapter<ListMovieAdapter.ListMovieViewHolder>() {
    ...
    class ListMovieViewHolder(private val binding: ItemListMovieBinding): RecyclerView.ViewHolder(binding.root){
