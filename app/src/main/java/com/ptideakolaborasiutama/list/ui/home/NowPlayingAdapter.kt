...
import com.ptideakolaborasiutama.list.databinding.ItemNowPlayingBinding
        ...
        fun bind(movieEntity: MovieEntity){
            with(binding){
                ...
                itemView.setOnClickListener {
                    val intent = Intent(itemView.context, com.ptideakolaborasiutama.list.ui.detail.DetailActivity::class.java)
                    intent.putExtra(com.ptideakolaborasiutama.list.ui.detail.DetailActivity.EXTRA_MOVIE, movieEntity.id)
